...
public class Reservation {
    ...
    private int tableNumber; // Required only if reservationType is DINE_IN
    ...
    @Enumerated(EnumType.STRING)
    private ReservationStatus status = ReservationStatus.PENDING;// PENDING, CONFIRMED, COMPLETED, CANCELLED
